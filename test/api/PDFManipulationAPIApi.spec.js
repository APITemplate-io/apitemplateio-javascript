...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.PDFManipulationAPIApi();
  });
  ...
  describe('PDFManipulationAPIApi', function() {
    describe('mergePdfs', function() {
      it('should call mergePdfs successfully', function(done) {
        //uncomment below and update the code to test mergePdfs
        //instance.mergePdfs(function(error) {
