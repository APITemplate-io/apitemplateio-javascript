...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessListTemplatesTemplatesInner();
  });
  ...
  describe('ResponseSuccessListTemplatesTemplatesInner', function() {
    it('should create an instance of ResponseSuccessListTemplatesTemplatesInner', function() {
      // uncomment below and update the code to test ResponseSuccessListTemplatesTemplatesInner
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessListTemplatesTemplatesInner();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessListTemplatesTemplatesInner);
    });
