...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessPDFFile();
  });
  ...
  describe('ResponseSuccessPDFFile', function() {
    it('should create an instance of ResponseSuccessPDFFile', function() {
      // uncomment below and update the code to test ResponseSuccessPDFFile
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessPDFFile();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessPDFFile);
    });
