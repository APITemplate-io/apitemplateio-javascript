...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessDeleteObject();
  });
  ...
  describe('ResponseSuccessDeleteObject', function() {
    it('should create an instance of ResponseSuccessDeleteObject', function() {
      // uncomment below and update the code to test ResponseSuccessDeleteObject
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessDeleteObject();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessDeleteObject);
    });
