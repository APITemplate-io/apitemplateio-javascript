...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessImageFile();
  });
  ...
  describe('ResponseSuccessImageFile', function() {
    it('should create an instance of ResponseSuccessImageFile', function() {
      // uncomment below and update the code to test ResponseSuccessImageFile
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessImageFile();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessImageFile);
    });
    ...
    it('should have the property downloadUrlPng (base name: "download_url_png")', function() {
      // uncomment below and update the code to test the property downloadUrlPng
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessImageFile();
      //expect(instance).to.be();
    });
    ...
    it('should have the property transactionRef (base name: "transaction_ref")', function() {
      // uncomment below and update the code to test the property transactionRef
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessImageFile();
      //expect(instance).to.be();
    });

    it('should have the property postActions (base name: "post_actions")', function() {
      // uncomment below and update the code to test the property postActions
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessImageFile();
      //expect(instance).to.be();
    });
