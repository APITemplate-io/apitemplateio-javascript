...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessQueryImageTemplate();
  });
  ...
  describe('ResponseSuccessQueryImageTemplate', function() {
    it('should create an instance of ResponseSuccessQueryImageTemplate', function() {
      // uncomment below and update the code to test ResponseSuccessQueryImageTemplate
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessQueryImageTemplate();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessQueryImageTemplate);
    });
