...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.MergePdfsRequest();
  });
  ...
  describe('MergePdfsRequest', function() {
    it('should create an instance of MergePdfsRequest', function() {
      // uncomment below and update the code to test MergePdfsRequest
      //var instance = new ApiTemplateIoApiReference.MergePdfsRequest();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.MergePdfsRequest);
    });
    ...
    it('should have the property cloudStorage (base name: "cloud_storage")', function() {
      // uncomment below and update the code to test the property cloudStorage
      //var instance = new ApiTemplateIoApiReference.MergePdfsRequest();
      //expect(instance).to.be();
    });
