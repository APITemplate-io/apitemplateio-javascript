...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.UpdateTemplateRequest();
  });
  ...
  describe('UpdateTemplateRequest', function() {
    it('should create an instance of UpdateTemplateRequest', function() {
      ...
      //var instance = new ApiTemplateIoApiReference.UpdateTemplateRequest();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.UpdateTemplateRequest);
    });
