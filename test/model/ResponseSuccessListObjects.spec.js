...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessListObjects();
  });
  ...
  describe('ResponseSuccessListObjects', function() {
    it('should create an instance of ResponseSuccessListObjects', function() {
      // uncomment below and update the code to test ResponseSuccessListObjects
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessListObjects();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessListObjects);
    });
