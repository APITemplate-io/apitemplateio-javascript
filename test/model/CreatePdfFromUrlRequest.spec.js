...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.CreatePdfFromUrlRequest();
  });
  ...
  describe('CreatePdfFromUrlRequest', function() {
    it('should create an instance of CreatePdfFromUrlRequest', function() {
      // uncomment below and update the code to test CreatePdfFromUrlRequest
      //var instance = new ApiTemplateIoApiReference.CreatePdfFromUrlRequest();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.CreatePdfFromUrlRequest);
    });
