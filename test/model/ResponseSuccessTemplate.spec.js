...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessTemplate();
  });
  ...
  describe('ResponseSuccessTemplate', function() {
    it('should create an instance of ResponseSuccessTemplate', function() {
      // uncomment below and update the code to test ResponseSuccessTemplate
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessTemplate();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessTemplate);
    });
