...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.CreatePdfFromHtmlRequest();
  });
  ...
  describe('CreatePdfFromHtmlRequest', function() {
    it('should create an instance of CreatePdfFromHtmlRequest', function() {
      // uncomment below and update the code to test CreatePdfFromHtmlRequest
      //var instance = new ApiTemplateIoApiReference.CreatePdfFromHtmlRequest();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.CreatePdfFromHtmlRequest);
    });
