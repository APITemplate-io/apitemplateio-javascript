...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccess();
  });
  ...
  describe('ResponseSuccess', function() {
    it('should create an instance of ResponseSuccess', function() {
      // uncomment below and update the code to test ResponseSuccess
      //var instance = new ApiTemplateIoApiReference.ResponseSuccess();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccess);
    });
