...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessListTemplates();
  });
  ...
  describe('ResponseSuccessListTemplates', function() {
    it('should create an instance of ResponseSuccessListTemplates', function() {
      // uncomment below and update the code to test ResponseSuccessListTemplates
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessListTemplates();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessListTemplates);
    });
