...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTemplateIoApiReference.ResponseSuccessSingleFile();
  });
  ...
  describe('ResponseSuccessSingleFile', function() {
    it('should create an instance of ResponseSuccessSingleFile', function() {
      // uncomment below and update the code to test ResponseSuccessSingleFile
      //var instance = new ApiTemplateIoApiReference.ResponseSuccessSingleFile();
      //expect(instance).to.be.a(ApiTemplateIoApiReference.ResponseSuccessSingleFile);
    });
