...
/**
 * The ResponseSuccessDeleteObject model module.
 * @module model/ResponseSuccessDeleteObject
 * @version Version 2.0
 */
class ResponseSuccessDeleteObject {
    /**
     * Constructs a new <code>ResponseSuccessDeleteObject</code>.
     * @alias module:model/ResponseSuccessDeleteObject
     */
    constructor() { 
        
        ResponseSuccessDeleteObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessDeleteObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessDeleteObject} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessDeleteObject} The populated <code>ResponseSuccessDeleteObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessDeleteObject();

            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], 'String');
            }
            if (data.hasOwnProperty('transaction_ref')) {
                obj['transaction_ref'] = ApiClient.convertToType(data['transaction_ref'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessDeleteObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessDeleteObject</code>.
     */
 ...
 */
ResponseSuccessDeleteObject.prototype['status'] = undefined;

/**
 * @member {Object} transaction_ref
 */
ResponseSuccessDeleteObject.prototype['transaction_ref'] = undefined;
...
export default ResponseSuccessDeleteObject;
