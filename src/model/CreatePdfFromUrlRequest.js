...
/**
 * The CreatePdfFromUrlRequest model module.
 * @module model/CreatePdfFromUrlRequest
 * @version Version 2.0
 */
class CreatePdfFromUrlRequest {
    /**
     * Constructs a new <code>CreatePdfFromUrlRequest</code>.
     * @alias module:model/CreatePdfFromUrlRequest
     */
    constructor() { 
        
        CreatePdfFromUrlRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePdfFromUrlRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePdfFromUrlRequest} obj Optional instance to populate.
     * @return {module:model/CreatePdfFromUrlRequest} The populated <code>CreatePdfFromUrlRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePdfFromUrlRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePdfFromUrlRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePdfFromUrlRequest</code>.
     */
 ...
 * @member {String} url
 */
CreatePdfFromUrlRequest.prototype['url'] = undefined;

/**
 * @member {module:model/PDFGenerationSettingsObject} settings
 */
CreatePdfFromUrlRequest.prototype['settings'] = undefined;
...
export default CreatePdfFromUrlRequest;
