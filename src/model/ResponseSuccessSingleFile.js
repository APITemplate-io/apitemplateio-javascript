...
/**
 * The ResponseSuccessSingleFile model module.
 * @module model/ResponseSuccessSingleFile
 * @version Version 2.0
 */
class ResponseSuccessSingleFile {
    /**
     * Constructs a new <code>ResponseSuccessSingleFile</code>.
     * @alias module:model/ResponseSuccessSingleFile
     */
    constructor() { 
        
        ResponseSuccessSingleFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessSingleFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessSingleFile} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessSingleFile} The populated <code>ResponseSuccessSingleFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessSingleFile();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessSingleFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessSingleFile</code>.
     */
 ...
 */
ResponseSuccessSingleFile.prototype['status'] = undefined;

/**
 * Generated PDF document
 * @member {String} primary_url
 */
ResponseSuccessSingleFile.prototype['primary_url'] = undefined;

/**
 * Page count
 * @member {Number} total_pages
 */
ResponseSuccessSingleFile.prototype['total_pages'] = undefined;

/**
 * Transaction reference
 * @member {String} transaction_ref
 */
ResponseSuccessSingleFile.prototype['transaction_ref'] = undefined;
...
export default ResponseSuccessSingleFile;
