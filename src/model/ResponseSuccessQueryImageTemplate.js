...
/**
 * The ResponseSuccessQueryImageTemplate model module.
 * @module model/ResponseSuccessQueryImageTemplate
 * @version Version 2.0
 */
class ResponseSuccessQueryImageTemplate {
    /**
     * Constructs a new <code>ResponseSuccessQueryImageTemplate</code>.
     * @alias module:model/ResponseSuccessQueryImageTemplate
     */
    constructor() { 
        
        ResponseSuccessQueryImageTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessQueryImageTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessQueryImageTemplate} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessQueryImageTemplate} The populated <code>ResponseSuccessQueryImageTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessQueryImageTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessQueryImageTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessQueryImageTemplate</code>.
     */
 ...
 */
ResponseSuccessQueryImageTemplate.prototype['status'] = undefined;

/**
 * Width
 * @member {Number} width
 */
ResponseSuccessQueryImageTemplate.prototype['width'] = undefined;

/**
 * Height
 * @member {Number} height
 */
ResponseSuccessQueryImageTemplate.prototype['height'] = undefined;

/**
 * Array of layers
 * @member {Array.<Object>} layers
 */
ResponseSuccessQueryImageTemplate.prototype['layers'] = undefined;
...
export default ResponseSuccessQueryImageTemplate;
