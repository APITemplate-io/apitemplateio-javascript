...
/**
 * The ResponseSuccessListObjects model module.
 * @module model/ResponseSuccessListObjects
 * @version Version 2.0
 */
class ResponseSuccessListObjects {
    /**
     * Constructs a new <code>ResponseSuccessListObjects</code>.
     * @alias module:model/ResponseSuccessListObjects
     */
    constructor() { 
        
        ResponseSuccessListObjects.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessListObjects</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessListObjects} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessListObjects} The populated <code>ResponseSuccessListObjects</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessListObjects();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessListObjects</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessListObjects</code>.
     */
 ...
 */
ResponseSuccessListObjects.prototype['status'] = undefined;

/**
 * @member {Array.<Object>} objects
 */
ResponseSuccessListObjects.prototype['objects'] = undefined;
...
export default ResponseSuccessListObjects;
