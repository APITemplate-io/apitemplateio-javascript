...
/**
 * The ResponseSuccessPDFFilePostActionsInner model module.
 * @module model/ResponseSuccessPDFFilePostActionsInner
 * @version Version 2.0
 */
class ResponseSuccessPDFFilePostActionsInner {
    /**
     * Constructs a new <code>ResponseSuccessPDFFilePostActionsInner</code>.
     * @alias module:model/ResponseSuccessPDFFilePostActionsInner
     */
    constructor() { 
        
        ResponseSuccessPDFFilePostActionsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessPDFFilePostActionsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessPDFFilePostActionsInner} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessPDFFilePostActionsInner} The populated <code>ResponseSuccessPDFFilePostActionsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessPDFFilePostActionsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessPDFFilePostActionsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessPDFFilePostActionsInner</code>.
     */
 ...
 */
ResponseSuccessPDFFilePostActionsInner.prototype['action'] = undefined;

/**
 * @member {String} name
 */
ResponseSuccessPDFFilePostActionsInner.prototype['name'] = undefined;

/**
 * @member {String} bucket
 */
ResponseSuccessPDFFilePostActionsInner.prototype['bucket'] = undefined;

/**
 * @member {String} status
 */
ResponseSuccessPDFFilePostActionsInner.prototype['status'] = undefined;

/**
 * @member {String} file
 */
ResponseSuccessPDFFilePostActionsInner.prototype['file'] = undefined;
...
export default ResponseSuccessPDFFilePostActionsInner;
