...
import ResponseSuccessListTemplatesTemplatesInner from './ResponseSuccessListTemplatesTemplatesInner';

/**
 * The ResponseSuccessListTemplates model module.
 * @module model/ResponseSuccessListTemplates
 * @version Version 2.0
 */
class ResponseSuccessListTemplates {
    /**
     * Constructs a new <code>ResponseSuccessListTemplates</code>.
     * @alias module:model/ResponseSuccessListTemplates
     */
    constructor() { 
        
        ResponseSuccessListTemplates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessListTemplates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessListTemplates} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessListTemplates} The populated <code>ResponseSuccessListTemplates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessListTemplates();

            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], 'String');
            }
            if (data.hasOwnProperty('templates')) {
                obj['templates'] = ApiClient.convertToType(data['templates'], [ResponseSuccessListTemplatesTemplatesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessListTemplates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessListTemplates</code>.
     */
    static validateJSON(data) {
        ...
        if (data['templates']) { // data not null
            ...
            for (const item of data['templates']) {
                ResponseSuccessListTemplatesTemplatesInner.validateJSON(item);
            };
        }
 ...
 */
ResponseSuccessListTemplates.prototype['status'] = undefined;

/**
 * @member {Array.<module:model/ResponseSuccessListTemplatesTemplatesInner>} templates
 */
ResponseSuccessListTemplates.prototype['templates'] = undefined;
...
export default ResponseSuccessListTemplates;
