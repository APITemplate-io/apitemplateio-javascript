...
/**
 * The ResponseSuccessImageFile model module.
 * @module model/ResponseSuccessImageFile
 * @version Version 2.0
 */
class ResponseSuccessImageFile {
    /**
     * Constructs a new <code>ResponseSuccessImageFile</code>.
     * @alias module:model/ResponseSuccessImageFile
     */
    constructor() { 
        
        ResponseSuccessImageFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseSuccessImageFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseSuccessImageFile} obj Optional instance to populate.
     * @return {module:model/ResponseSuccessImageFile} The populated <code>ResponseSuccessImageFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseSuccessImageFile();
            ...
            if (data.hasOwnProperty('download_url_png')) {
                obj['download_url_png'] = ApiClient.convertToType(data['download_url_png'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseSuccessImageFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseSuccessImageFile</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['download_url_png'] && !(typeof data['download_url_png'] === 'string' || data['download_url_png'] instanceof String)) {
            throw new Error("Expected the field `download_url_png` to be a primitive type in the JSON string but got " + data['download_url_png']);
        }
        // ensure the json data is a string
 ...
 */
ResponseSuccessImageFile.prototype['status'] = undefined;

/**
 * Download URL
 * @member {String} download_url
 */
ResponseSuccessImageFile.prototype['download_url'] = undefined;

/**
 * Download URL PNG
 * @member {String} download_url_png
 */
ResponseSuccessImageFile.prototype['download_url_png'] = undefined;

/**
 * Template ID
 * @member {String} template_id
 */
ResponseSuccessImageFile.prototype['template_id'] = undefined;

/**
 * Transaction reference
 * @member {String} transaction_ref
 */
ResponseSuccessImageFile.prototype['transaction_ref'] = undefined;

/**
 * @member {Array.<module:model/ResponseSuccessPDFFilePostActionsInner>} post_actions
 */
ResponseSuccessImageFile.prototype['post_actions'] = undefined;
...
export default ResponseSuccessImageFile;
