...
class UpdateTemplateRequest {
     ...
     * @param templateId {String} Your template id, it can be obtained in the web console(Manage Templates) 
     */
    constructor(templateId) { 
        
        UpdateTemplateRequest.initialize(this, templateId);
    }
...
UpdateTemplateRequest.RequiredProperties = ["template_id"];
 ...
 * @member {String} body
 */
UpdateTemplateRequest.prototype['body'] = undefined;

/**
 * The css 
 * @member {String} css
 */
UpdateTemplateRequest.prototype['css'] = undefined;
